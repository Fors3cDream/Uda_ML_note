"""
Create by Killer at 2019-04-25 15:23
"""
...
def check_creating_pet_image_labels(petlabels_dic):
    ...
    print("\nPet Image Label Dictionary has", len(petlabels_dic), "key-value pairs.\nBelow are 10 of them:")
    ...
    for key in petlabels_dic:
        if n < 10:
            print("%2d Key: %-30s  label: %-26s" % (n+1, key, petlabels_dic[key]))
...
def check_classifying_images(results_dic):
    ...
    print("\n# Total Iamges", n_match + n_notmatch, "# Matches:", n_match, "# NOT Matches:", n_notmatch)
