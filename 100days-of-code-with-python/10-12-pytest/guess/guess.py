"""
Create by Killer at 2019-05-16 09:30
"""
...
class Game:
    ...
    def __init__(self):
        """Init _guesses, _answer, _win to set(), get_random_number(), Fasle"""
        self._guesses = set()
    ...
    def __call__(self):
        ...
        """
        while len(self._guesses) < MAX_GUESS:
            try:
                guess = self.guess()
            ...
            print(f'Guessed {MAX_GUESS} times, answer was {self._answer}')
